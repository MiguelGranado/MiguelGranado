...
Theme: Ulamander (dark #0d1117, orange #fe702d) — arifhaxn-style terminal cards.
"""
...
THEMES = {
    "dark": {
        "BG": "#0d1117", "PANEL": "#161b22", "PANEL_BAR": "#12171f",
        "CYAN": "#fe702d", "VIOLET": "#fb923c", "VIOLET2": "#c2410c",
        "EMERALD": "#22c55e", "TEXT": "#F8FAFC", "MUTED": "#94A3B8",
        "DIM": "#64748B",
        "STROKE": "rgba(254,112,45,0.35)", "STROKE_HI": "rgba(254,112,45,0.65)",
        "STROKE_LO": "rgba(254,112,45,0.22)", "BARLINE": "rgba(255,255,255,0.08)",
        "RING_BG": "rgba(148,163,184,0.15)", "PILL_BG": "rgba(254,112,45,0.18)",
        "PILL_STROKE": "rgba(251,146,60,0.5)", "MONO_TX": "#FFF7ED",
    },
    "light": {
        "BG": "#F8FAFC", "PANEL": "#FFFFFF", "PANEL_BAR": "#F1F5F9",
        "CYAN": "#ea580c", "VIOLET": "#c2410c", "VIOLET2": "#c2410c",
        "EMERALD": "#059669", "TEXT": "#0F172A", "MUTED": "#475569",
        "DIM": "#94A3B8",
        "STROKE": "rgba(234,88,12,0.30)", "STROKE_HI": "rgba(234,88,12,0.55)",
        "STROKE_LO": "rgba(234,88,12,0.20)", "BARLINE": "rgba(0,0,0,0.08)",
        "RING_BG": "rgba(100,116,139,0.20)", "PILL_BG": "rgba(234,88,12,0.12)",
        "PILL_STROKE": "rgba(194,65,12,0.4)", "MONO_TX": "#FFFFFF",
    },
}
...
def set_theme(name):
    ...
    for k, v in t.items():
        g[k] = v
    g["DONUT_COLORS"] = [t["CYAN"], t["VIOLET"], t["EMERALD"], "#fb923c", "#64748B", "#94A3B8"]
...
def card(p, x, y, idx):
    ...
    if url:
        ...
        href = "https://miguel.ulamander.com/#proyectos"
    title_bar = esc(p.get("subtitle") or repo or p.get("badge") or "ulamander")
    ...
    a(f'<text x="16" y="19" font-size="10" fill="{MUTED}"><tspan fill="{CYAN}">&#8226;</tspan> {title_bar}</text>')
