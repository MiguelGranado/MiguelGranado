...
**Ulamander-Neural** — chat con IA 100% local, panel de fine-tuning/destilación de modelos
(maestro→alumno vía QLoRA), y un exportador multi-placa (Raspberry Pi, compute de bajos
recursos, firmware ESP32/Arduino).
